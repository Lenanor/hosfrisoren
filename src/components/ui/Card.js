...
function Card({ title, body, cta }) {
  const ariaId = `cta-${title.replace(/\s+/g, "-").toLowerCase()}`;
  ...
  return (
    ...
    >
      ...
      <p className={styles.readMore} aria-hidden="true" id={ariaId}>
        Läs mer
      </p>
    </li>
  );
